 ...
 * @author nidhitiwari
 */
public class ManageNGOInfo extends javax.swing.JPanel {
    ...
    /**
     * Creates new form ManageNGOInfo
     */
    public ManageNGOInfo(JPanel userProcessContainer,UserAccount account, BusinessModel business) {
        initComponents();
    ...
    private void updateNGOInfo() {
        for(NGO ngo:business.getNgoDirectory().getNGOList()){
           if(ngo.getNgoAdminUserName().equals(account.getUsername())){
               txtNgoName.setText(ngo.getNgoName());
               txtNgoContact.setText(ngo.getNgoContact());
               txtNgoAddress.setText(ngo.getNgoAddress());
            }         
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage NGO Info");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagesNgo/ngo_hands.jpeg"))); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtNgoName, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE)
                                    .addComponent(txtNgoContact)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String number=txtNgoContact.getText();
